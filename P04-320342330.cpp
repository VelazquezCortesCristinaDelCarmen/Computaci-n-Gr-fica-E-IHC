...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-4.0f, 0.25f, 4.5f));
		...
		meshList[0]->RenderMesh();
		//Tubo en +Z
		model = glm::translate(model, glm::vec3(-1.2f, -0.8f, 0.75f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(120.0f),
			glm::vec3(0.0f, 0.0f, 1.0f));//rotar alrededor de z 120°
		...
		//Pata en +Z
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.5f, -0.4f, -0.55f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(120.0f),
			glm::vec3(0.0f, 0.0f, 1.0f));//rotar alrededor de z 120°
		model = glm::scale(model, glm::vec3(0.5f, 2.0f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMeshGeometry();
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.3f, -1.05f, -0.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-150.0f),
			glm::vec3(0.0f, 0.0f, 1.0f));//rotar alrededor de z 120°
		model = glm::scale(model, glm::vec3(0.5f, 2.0f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		...
		//Eje rueda en +Z
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.2f, -0.4f, 1.1f));
		model = glm::rotate(model, glm::radians(90.0f),
			glm::vec3(1.0f, 0.0f, 0.0f));//rotar alrededor de z 90°
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.5f, 1.3f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(45.0f),
			glm::vec3(0.0f, 0.0f, 1.0f));//rotar alrededor de z 45°
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(-90.0f),
			glm::vec3(0.0f, 0.0f, 1.0f));//rotar alrededor de z -90°
		model = glm::scale(model, glm::vec3(0.5f, 4.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//eje 1
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -0.25f, 4.5f));
		...
		//pata
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.4f, -2.2f, 0.2f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(150.0f), 
			glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//eje 2
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.1f, -1.5f, 1.6f));
		...
		//eje 1
		model = modelaux2;
		model = glm::translate(model, glm::vec3(2.0f, -0.25f, 4.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion12()),
			glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f),
			glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(0.5f, 5.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 0.4f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry();
		//eje 2
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.1f, -1.5f, 1.6f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion13()),
			glm::vec3(0.0f, 0.0f, -1.0f));
		model = glm::rotate(model, glm::radians(90.0f),
			glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.1f, -1.5f, -1.6f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion14()),
			glm::vec3(0.0f, 0.0f, -1.0f));
		model = glm::rotate(model, glm::radians(90.0f),
			glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		...
		model = glm::rotate(model, glm::radians(90.0f), 
			glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.6f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		modelaux = model;
		model = modelaux;
		model = glm::scale(model, glm::vec3(0.3f, 9.0f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::scale(model, glm::vec3(2.0f, 8.0f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.9f, 0.4f, 0.9f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		//TRIANGULO PANEL 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 6.5f, 0.2f));
		model = glm::scale(model, glm::vec3(2.0f, 3.0f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
